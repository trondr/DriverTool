    ...
    module InstallXmlTests =         
        ...
        let loadInstallXmlTest (testDataObject:obj) =
            ...
            match(result {              
                ...
                let! installXmlPath = EmbeddedResouce.extractEmbeddedResouceByFileNameBase ("InstallXmlInstall.xml", tempDestinationFolderPath,"InstallXmlInstall.xml",typeof<ThisAssembly>.Assembly)
