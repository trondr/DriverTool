...
module F=
    ...
    let string2uIntUnsafe (numberString:string) =
        numberString |> uint

    let string2uInt numberString =
        tryCatchWithMessage string2uIntUnsafe numberString (sprintf "Failed to convert '%s' to unsiged integer." numberString)
