...
module HpCatalog =
    ...
    let downloadDriverPackCatalog cachedFolderPath reportProgress =
        result{            
            ...
            let! downloadResult = Web.downloadFile reportProgress (new Uri(soruceDriverPackCatalogCab)) true nonExistingDestinationCabFile
